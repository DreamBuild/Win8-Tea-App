...
namespace TeaApp.Views
{
    ...
    public sealed partial class DrinkTeaPage : Page
    {
        ...
        private async  void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            this.DefaultViewModel["Items"] = await dataSource.GetTeaItemsSaync();
        }
        ...
        private void teaList_ItemClick(object sender, ItemClickEventArgs e)
        {
            Tea tea = e.ClickedItem as Tea;
